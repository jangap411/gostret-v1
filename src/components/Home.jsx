...
export default function Home() {
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="px-4 py-3">
          <label className="flex flex-col min-w-40 h-12 w-full">
            <div className="flex w-full flex-1 items-stretch rounded-xl h-full shadow-sm hover:shadow transition-shadow">
              <div
              ...
              <input
                ...
                readOnly
                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#111518] focus:outline-0 focus:ring-0 border-none bg-[#f0f3f4] focus:border-none h-full placeholder:text-[#637888] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal cursor-pointer"
                defaultValue=""
              />
            </div>
          </label>
        ...
        <div className="@container flex flex-col h-full flex-1 mt-4 relative">
          <div className="flex flex-1 flex-col @[480px]:px-4 @[480px]:py-3">
            <div
              className="bg-cover bg-center flex min-h-[320px] flex-1 flex-col justify-between px-4 pb-4 pt-5 shadow-inner @[480px]:rounded-xl @[480px]:px-8 @[480px]:pb-6 @[480px]:pt-8"
            ...
            >
              <label className="flex flex-col min-w-40 h-12 shadow-md rounded-xl hover:shadow-lg transition-shadow">
                <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                  <div
                    className="text-[#637888] flex border-none bg-white items-center justify-center pl-4 rounded-l-xl border-r-0"
                    data-icon="MagnifyingGlass"
                    data-size="24px"
                    data-weight="regular"
                  >
                  ...
                  <input
                    ...
                    onClick={() => navigate('/search-location')}
                    readOnly
                    className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#111518] focus:outline-0 focus:ring-0 border-none bg-white focus:border-none h-full placeholder:text-[#637888] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal cursor-pointer"
                    defaultValue=""
                  />
                </div>
              </label>
              <div className="flex flex-col items-end gap-3 pointer-events-none">
                <div className="flex flex-col gap-0.5 pointer-events-auto">
                  <button className="flex size-10 hover:bg-neutral-100 transition-colors cursor-pointer items-center justify-center rounded-t-full bg-white shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
                  ...
                  <button className="flex size-10 hover:bg-neutral-100 transition-colors cursor-pointer items-center justify-center rounded-b-full bg-white shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
                ...
                <button className="flex size-10 hover:bg-neutral-100 transition-colors pointer-events-auto cursor-pointer items-center justify-center rounded-full bg-white shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
      ...
      <div>
        <div className="flex justify-end overflow-hidden px-5 pb-5 absolute bottom-24 right-0 pointer-events-none">
          <button className="flex max-w-[480px] pointer-events-auto hover:bg-[#2580c4] hover:shadow-lg transition-all cursor-pointer items-center justify-center overflow-hidden rounded-full h-14 bg-[#309be8] text-white text-base font-bold leading-normal tracking-[0.015em] min-w-0 px-2 pl-4 pr-6 shadow-md">
        ...
        <div className="flex gap-2 border-t border-[#f0f3f4] bg-white px-4 pb-3 pt-2 relative z-10 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
