      ...
      <div>
        ...
        <div className="flex flex-col gap-1 mt-2">
          ...
          {[
            ...
            <div key={i} className="flex items-center gap-4 hover:bg-neutral-100 cursor-pointer transition px-4 min-h-14">
              <div className="text-[#141414] flex items-center justify-center rounded-lg bg-[#ededed] shrink-0 size-10" data-icon={item.icon} data-size="24px" data-weight="regular">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
