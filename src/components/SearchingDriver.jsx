  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 100) {
          clearInterval(timer);
          setTimeout(() => navigate('/driver-en-route'), 500);
          return 100;
        }
        return prev + 1;
      });
    }, 100); // ~10 seconds total search time
    ...
    <div className="relative flex size-full h-full flex-col bg-white overflow-hidden" style={{ fontFamily: '"Plus Jakarta Sans", "Noto Sans", sans-serif' }}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/60 backdrop-blur-[1px]">
        ...
        <div className="mt-12 text-center px-8">
            ...
            <p className="text-neutral-500 font-medium">Finding the best route and nearby rides for you...</p>
        </div>
