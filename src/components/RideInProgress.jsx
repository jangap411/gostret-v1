      ...
      <div>
        <div className="@container flex flex-col h-full flex-1">
          <div className="flex flex-1 flex-col @[480px]:px-4 @[480px]:py-3 h-screen">
            <div
              className="bg-cover bg-center flex min-h-[320px] h-full flex-1 flex-col justify-between px-4 pb-4 pt-5 @[480px]:rounded-xl @[480px]:px-8 @[480px]:pb-6 @[480px]:pt-8 fixed inset-0 z-0"
              style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCoE0ouSYrWo7q_gSyr6_jyWTWA8cMFIpPyAHkdoIJUkGR44VPSUZXkwpLu03brXOrEolGXjT_00WBPhlo5Au2reH-ei83eQE3TjuH7iTeI2zmhwuH25osIaRCaXeehh_2DcE3AuMqlFRZkHZNJm_wLnzzf0htIvw2rP_e0GPZnJW2t-3g1pbcwmR2OduAvQ7GO1oU4THU70h4VWkU2fYsrGVXo4prPio-dGSFOusmWvfQ0srTlNrSo3-jyr-m5psNHf0CTdg4aj_Y")' }}
            >
              ...
              <div className="flex flex-col items-end gap-3 mb-48 pointer-events-none">
