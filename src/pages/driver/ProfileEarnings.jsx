          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-primary-container">
              <img
                ...
                data-alt="Professional headshot of a friendly middle-aged male driver in a clean polo shirt, warm studio lighting, neutral background"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAcyFZMHjBHrf_ZO-rM6lzJYypBZKh_7XL3WBKDgYHNcQOCP8lVyfHWiHMSVNNgAthu7on4Zs5CaXlnHNrBLeMXADcKXK6h7ahhk6gszVjfIQJ6RA2Ufj65a4efj2477ckDXfMVjnOtwSZnWIa17zHCznLsUD5fbx5E2AaTwUGc4DCHeNc4VHouRxa_6XP8lMXG4Tv_9PrebfmcS7Lx38rRw-FxIV8guTWXAzxJM3l6tXw0CSm9NwfmfjDSqq1XvM85oq-_RS4XPwGS"
                alt="Driver profile"
              />
            </div>
      ...
      <main className="pt-24 pb-32 px-6 max-w-2xl mx-auto space-y-8">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2 bg-surface-container-lowest p-6 rounded-3xl shadow-[0_4px_24px_rgba(3,22,54,0.04)] flex items-center justify-between">
            <div>
              <h2 className="font-headline font-extrabold text-3xl text-primary tracking-tight">Marcus Chen</h2>
              <p className="text-on-surface-variant font-medium mt-1">Professional Partner since 2021</p>
            </div>
            <div className="text-right">
              <div className="flex items-center justify-end text-on-tertiary-container gap-1">
                ...
                <span className="font-headline font-bold text-2xl">4.98</span>
              </div>
          ...
          <div className="bg-surface-container-low p-5 rounded-3xl">
            ...
            <p className="font-headline font-extrabold text-2xl text-primary">2,842</p>
          </div>
          <div className="bg-surface-container-low p-5 rounded-3xl">
            <p className="text-on-surface-variant text-xs font-bold uppercase tracking-widest mb-2">Years Active</p>
            <p className="font-headline font-extrabold text-2xl text-primary">3.5</p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-end px-2">
            <div>
              ...
              <p className="text-on-surface-variant text-sm">Oct 23 - Oct 29</p>
            </div>
            <div className="text-right">
              <p className="font-headline font-extrabold text-3xl text-primary">$1,248.50</p>
            </div>
          </div>
          ...
          <div className="bg-surface-container-lowest p-6 rounded-3xl shadow-sm space-y-6">
            ...
            {/* Cash Out Button */}
            <button className="w-full bg-gradient-to-r from-primary to-primary-container text-on-primary py-5 rounded-2xl font-headline font-bold text-lg shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-3">
        ...
        {/* Log Out */}
        <button className="w-full py-4 text-on-tertiary-container font-headline font-bold tracking-tight active:scale-95 transition-transform">
          Sign Out of Account
        </button>
      </main>
